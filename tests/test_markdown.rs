use bicep_docs::{parse_bicep_document, export_bicep_document_to_markdown_string, parse_and_export_to_markdown};
use std::fs;
...
mod markdown {
    ...
    fn test_markdown_export() {
        ...
        let content = fs::read_to_string("tests/parsing/parameters.bicep")
            .expect("Failed to read test file");
        
        // Parse the document
        let document = parse_bicep_document(&content)
